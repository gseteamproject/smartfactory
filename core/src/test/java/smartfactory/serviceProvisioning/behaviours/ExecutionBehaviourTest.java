...
import smartfactory.serviceProvisioning.behaviours.ExecutionBehaviour;
import smartfactory.serviceProvisioning.behaviours.ServiceProvisioningResponderBehaviour;
import smartfactory.utility.AgentDataStore;

public class ExecutionBehaviourTest {
	...
	public void setUp() {
		...
		testable = new ExecutionBehaviour(interactionBehaviour_mock, dataStore_mock);
	}

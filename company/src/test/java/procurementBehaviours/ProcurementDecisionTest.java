...
public class ProcurementDecisionTest {
	...
	public void setUp() {
		...
		testable = new ProcurementDecision(responderBehaviour_mock, agentDataStore_mock);
	}
		...
		context.checking(new Expectations() {
			{
				...
				// TODO : add Matcher
				oneOf(agentPlatform_mock).sendMessageToWebClient(null);

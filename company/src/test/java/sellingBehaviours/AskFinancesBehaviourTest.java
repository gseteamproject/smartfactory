...
public class AskFinancesBehaviourTest {
	...
	public void setUp() {
		...
		testable = new AskFinancesBehaviour(responderBehaviour_mock, agentDataStore_mock);
	}
		...
		context.checking(new Expectations() {
			{
				...
				// TODO : add Matcher
				oneOf(agent_mock).addBehaviour(with(any(AskFinancesInitiatorBehaviour.class)));
			}
		});

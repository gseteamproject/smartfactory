...
public class ProcurementMarketDecisionTest {
	...
	ProcurementMarketDecision testable;
	...
	public void setUp() {
		...
		testable = new ProcurementMarketDecision(responderBehaviour_mock, agentDataStore_mock);
	}

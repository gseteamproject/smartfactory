...
public class AskForMaterialsBehaviourTest {
	...
	AskForMaterialsBehaviour testable;
	...
	public void setUp() {
		...
		testable = new AskForMaterialsBehaviour(responderBehaviour_mock, agentDataStore_mock);
	}
		...
		context.checking(new Expectations() {
			{
				...
				// TODO : add Matcher
				oneOf(agent_mock).addBehaviour(with(any(AskForMaterialsInitiatorBehaviour.class)));
			}
		});

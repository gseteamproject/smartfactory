...
public class TakeFromStorageInitiatorTest {
	...
	TakeFromStorageInitiator testable;
	...
	public void setUp() {
		...
		testable = new TakeFromStorageInitiator(responderBehaviour_mock, agentDataStore_mock);
	}
		...
		context.checking(new Expectations() {
			{
				...
				// TODO : add Matcher
				oneOf(agent_mock).addBehaviour(with(any(DeliverToSellingBehaviour.class)));
			}
		});
